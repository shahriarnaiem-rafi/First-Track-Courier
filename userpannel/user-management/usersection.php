...
require_once __DIR__ . "/../connect/staff_auth.php";
    ...
    */
    ...
    if (
        ...
        */
        ...
        $sender_branch = trim($_POST['senderBranch'] ?? "");
        $receiver_branch = trim($_POST['receiverBranch'] ?? "");
        ...
        */
        ...
        if (!in_array($service_type, ["Standard", "Express"], true)) {
            ...
            $form_error =
                "Weight must be between 1 and 20,000 grams.";
            ...
            */
            ...
            |
            | NOTE:
            | sender_branch and receiver_branch are included here.
            |
            | These two columns MUST exist in customer_section.
            |
            */

            $sql = "
                INSERT INTO customer_section
                (
                    service_type,
                    sender_name,
                    sender_address,
                ...
                */
                ...
                if ($stmt->execute()) {
                    ...
                    */
                    ...
                    $payment_stmt =
                        $database->prepare($payment_sql);


                    if (!$payment_stmt) {

                        $form_error =
                            "Order created, but payment could not be prepared.";
            ...
            <div class="customer-form-column">
                ...
                <div class="customer-form-group">
                    ...
                    <span class="service-help">
                        ...
                        Select the delivery service required
                        for this parcel.
